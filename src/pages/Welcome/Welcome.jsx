...
export default function Welcome() {
  ...
  return (
    <div>
      ...
      {/* Hero Section */}
      <section className="relative isolate px-6 pt-14 lg:px-8 text-left"> {/* Add text-left class */}
        {/* Background shape */}
        <div
      ...
      <section id="about" className="bg-blue-100">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-7xl py-12 sm:py-20 text-left"> {/* Add text-left class */}
      ...
      <section className="bg-gray-100">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-2xl py-12 sm:py-20 text-left"> {/* Add text-left class */}
            <h2 className="text-4xl font-bold text-center text-gray-900 mb-8">
              Contact Us
            </h2>
            <div className="text-xl leading-7 text-gray-800">
